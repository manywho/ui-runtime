...
manywho.engine = (function (manywho) {
        ...
        if (components) {
            ...
            var requestComponents = manywho.utils.convertToArray(components).filter(function (component) {
                ...
                if (component.attributes 
                    && (component.attributes.isExecuteRequestOnRenderDisabled === true || manywho.utils.isEqual(component.attributes.isExecuteRequestOnRenderDisabled, 'true', true)))
                    return false;
    ...
    return {
        ...
        fileDataRequest: function (id, request, flowKey, limit, search, orderBy, orderByDirection, page) {
            ...
            return manywho.ajax.dispatchFileDataRequest(request, manywho.utils.extractTenantId(flowKey), manywho.utils.extractStateId(flowKey), manywho.state.getAuthenticationToken(flowKey), limit, search, orderBy, orderByDirection, page)
                .then(function (response) {

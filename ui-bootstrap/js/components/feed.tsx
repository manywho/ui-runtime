...
class Feed extends React.Component<IComponentProps, ErrorBoundary> {
    ...
    renderThread(messages, isCommentingEnabled, isAttachmentsEnabled?) {
        const FeedInput: typeof feedInput = manywho.component.getByName(
            registeredComponents.FEED_INPUT,
        );
            ...
            return (
                <ul className={'media-list'}>
                    {messages.map((message) => {
                        ...
                        return (
                            <li className={'media'} key={createdDate.toLocaleString()}>
                ...
                <div className={'panel panel-default feed'}>
                    <div className={'panel-heading clearfix'}>
                        ...
                        <div className={'pull-right btn-group'}>
                            ...
                            <button className={'btn btn-default btn-sm'} onClick={this.onRefresh}>
...
export const getFeed = (): typeof Feed =>
    manywho.component.getByName(registeredComponents.FEED) || Feed;

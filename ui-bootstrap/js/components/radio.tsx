...
class Radio extends React.Component<IComponentProps, any> {
    ...
    renderOption = (item, attributes, column, developerName, selectedItems, flowKey) => {
        ...
        if (item.properties) {
            ...
            manywho.utils.extend(optionAttributes, [
                attributes,
                {
                    type,
                    name: developerName,
    ...
    render() {
        ...
        if (!this.props.isDesignTime) {
            ...
            const columnTypeElementPropertyId = displayColumns
            ...
            if (!this.isEmptyObjectData(model)) {
                ...
                if (state && state.objectData) {
                    ...
                    selectedItems = model.objectData
                ...
                options = columnTypeElementPropertyId
        ...
        if (model.isVisible === false) containerClassNames.push('hidden');
        ...
        if (!state.loading || state.error) iconClassNames.push('hidden');
        ...
        const radioElement = (
            <div>
                ...
                {options ? (
                    <div className={'radio-group'}>{options}</div>
                ) : (

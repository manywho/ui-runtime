    ...
    renderOutcome(outcome, selectedOutcome, outcomeWidth) {
        ...
        return (
            <div className={classes} style={{ width: outcomeWidth }}>
                <p style={{ textAlign: 'center' }}>{outcome.label}</p>
            </div>
        );
    }
        ...
        if (
            ...
            return (
                <div className={'panel panel-default history-view'}>
                    ...
                    <div className={'panel-body'}>{this.renderSteps(historyData)}</div>
                </div>
            );
        }
...
export const getHistory = (): typeof History =>
    manywho.component.getByName(registeredComponents.HISTORY) || History;

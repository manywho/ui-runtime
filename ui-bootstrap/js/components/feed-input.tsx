...
class FeedInput extends React.Component<IFeedInputProps, IFeedInputState> {
    ...
    send = () => {
        ...
        if (
            this.fileUploadRef &&
            fileUploadElement &&
            fileUploadElement.state.fileNames.length > 0
        ) {
    ...
    render() {
        ...
        if (this.props.isAttachmentsEnabled) {
            const fileUploadProps = {
                ...
                upload: (
                    ...
                    manywho.social
                        .attachFiles(flowKey, formData, onProgress)
        ...
        return (
            <div className="feed-post clearfix">
                ...
                <button className="btn btn-sm btn-primary feed-post-send" onClick={this.send}>
                    {this.props.caption}
                </button>
            </div>
        );
...
export const getFeedInput = (): typeof FeedInput =>
    manywho.component.getByName(registeredComponents.FEED_INPUT) || FeedInput;
